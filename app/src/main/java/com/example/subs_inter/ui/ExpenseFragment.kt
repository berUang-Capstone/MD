...
class ExpenseFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val financeItems = listOf(
            FinanceAdapter.FinanceItem("Rent", 1000000, ContextCompat.getColor(requireContext(), R.color.expense_color)),
            FinanceAdapter.FinanceItem("Food", 500000, ContextCompat.getColor(requireContext(), R.color.expense_color)),
            FinanceAdapter.FinanceItem("Transport", 750000, ContextCompat.getColor(requireContext(), R.color.expense_color))
        )
